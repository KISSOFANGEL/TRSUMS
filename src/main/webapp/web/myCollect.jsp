...
var perpage=10;  //每页数
	...
	$.ajax({
		type:"POST",
		url:"<%=root%>/collect/getCollectByUserId",
		dataType:"json",
		async:false,
...
function delselectedmes(){
     ...
     $.ajax({
 		type:"POST",
 		url:"<%=root%>/collect/delCollectByIds",
 		dataType:"html",
 		async:false,
 		data:{ids:ids},
 		success:function(result){
  ...
  <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">收藏</strong> / <small>Collection</small></div>
    </div>
