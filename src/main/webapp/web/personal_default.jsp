...
$(function(){
  function getchannels(){
	//获得当前用户所对应角色的权限
	var options = {
			url: '<%=root%>/role/getchannelsbyuserid',
			callBackFun:function(data){
				if(data.isSuccessOrfail=="SUCCESS"){
					// 如果成功，重置表单的数据
					var tr='<tr><th class="am-text-center">序号</th><th>栏目名称</th></tr>';
					for(var i=0;i<data.rows.length;i++){
						tr+='<tr><td class="am-text-center">'+(i+1)+'</td><td>'+data.rows[i].chnldesc+'</td></tr>';
					}
					$('#channeltbody').html(tr);
    			}
...
<body style="height: 800px;" > 
 ...
 <div class="am-u-md-6">
        <div class="am-panel am-panel-default">
          <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-4'}">系统简讯<span class="am-icon-chevron-down am-fr" ></span></div>
         ...
         <div class="am-panel am-panel-default">
          <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-3'}">热门分享<span class="am-icon-chevron-down am-fr" ></span></div>
         ...
         <div class="am-u-md-6">
        <div class="am-panel am-panel-default">
          <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-1'}">订阅简讯<span class="am-icon-chevron-down am-fr" ></span></div>
...
<!-- 订阅内容 -->
  <div class="am-panel am-panel-default">
    ...
    <div id="do-not-say-1" class="am-panel-collapse am-collapse am-in">
        ...
        <div class="am-panel am-panel-default">
          <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-2'}">我的权限<span class="am-icon-chevron-down am-fr" ></span></div>
          <div id="collapse-panel-2" class="am-in" style="overflow-x: auto;height:320px;">
            <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
              ...
              <tr>
                <td class="am-text-center"><img src="../js/assets/i/examples/admin-firefox.png" alt=""></td>
                <td>Mozilla Firefox</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="../js/assets/i/examples/admin-ie.png" alt=""></td>
                <td>Internet Explorer</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="../js/assets/i/examples/admin-opera.png" alt=""></td>
                <td>Opera</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="../js/assets/i/examples/admin-safari.png" alt=""></td>
                <td>Safari</td>
              </tr>
               <tr>
                <td class="am-text-center"><img src="../js/assets/i/examples/admin-ie.png" alt=""></td>
